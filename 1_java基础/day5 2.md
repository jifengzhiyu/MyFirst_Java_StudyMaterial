...
list.add(0,"666");
public boolean remove(Object o)，删除指定的元素，返回删除是否成功，只能删除第一个指定元素
public E remove(int index)，删除指定索引处的元素，返回被删除的元素
publicE set(int index,Eelemet)，修改指定索引处的元素，返回被修改的元素
...
*      2. jdk 8底层的数组是：Node[],而非Entry[](结构还是一样的)
...
![image-20220514114354037](Pic/image-20220514114354037.png)
...
![image-20220514114637893](Pic/image-20220514114637893.png)
...
![image-20220514160425693](Pic/image-20220514160425693.png)
